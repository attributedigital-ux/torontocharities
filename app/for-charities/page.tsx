      ...
      <main className="max-w-2xl mx-auto px-4 py-16">
        ...
        <div className="space-y-8">
          ...
          <p className="text-sm text-tp-muted">
            Questions? Email <a href="mailto:hello@toronto-charities.ca" className="text-tp-blue hover:underline">hello@toronto-charities.ca</a> — our system handles requests automatically and usually replies within minutes.
          </p>
        </div>
      </main>
      <Footer />
